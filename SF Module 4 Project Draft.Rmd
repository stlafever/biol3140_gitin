...
*Anolis* is a well studied genus of iguanian reptiles that exists in many different ecomorphs, which are defines by groups of species with similar ecological niches and behaviors. Here, we aim to asses the relationship between hind limb length, size, and ecomorph using morphological and ecomorphological data from @Hagey2017 and phylogenetic data from @Poe2017. 
...
An Aic<sub>W</sub> evaluation determined the Brownian motion model of character evolution including ecomorph as a covariate of snout vent length to be the best model for predicting the total hind limb length of anoles from the snout vent length. 
