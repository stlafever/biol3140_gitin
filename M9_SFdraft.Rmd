...
species <- c("Hylocichla mustelina","Archilochus colubris","Seiurus aurocapilla","Progne subis","Icterus galbula")
...
saveRDS(dat,"bird.data.RDS")
dat <- readRDS("bird.data.RDS")
```

```{r station and weather data, cache=TRUE,echo=FALSE, warning=FALSE, error=FALSE, message=FALSE}
...
```{r arrival proportions,echo=FALSE, warning=FALSE, error=FALSE, message=FALSE}
