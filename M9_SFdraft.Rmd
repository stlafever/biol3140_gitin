...
## Introduction
Trans-Gulf migrants (TGMs) travel long distances to forage and breed. These birds migrate from Central and South America every spring to more temperate regions between Texas and Florida. Their time of arrival to the breeding grounds have differing tradeoffs and can affect the fitness of the migrants. A study found that early arrival correlates with higher chances of mating and breeding while later arrival benefits from surplus food availablility (@smith2005arrival). One study that studied migration patterns from 1828-2010, found a uniform trend of earlier arrivals correlated with higher temperatures from 1978 to 2010 (@kolavrova2017changes).  
...
ANOVA analysis on maximum temperature, minimum temperature, and wind was performed to determine the effect these variables have on arrival date. 
...
Anova(lmer) #Anova from the car package
