...
dat%>%
  ggplot(aes(angle,normF,col=exp))+geom_point()+geom_point(aes(x=c.mean,y=1.0),size=5,col="blue")+geom_point(aes(x=f.mean,y=1.0),size=5,col="red")+geom_smooth(method="lm", formula=y~poly(x,2))
```
